...
class Test extends Controller{
	public function test(){
		// $res = sendEmail('1325835938@qq.com','123123');
		// dump($res);
		$sendCode = createCode();
		$res = sendSms('15234366080',$sendCode);
		if($res->Code=='OK'){
			echo '发送成功';
		}else{
			echo '发送失败';
		...
		$mail->Username ='15910720087@163.com';

		//smtp登录的密码 使用生成的授权码（就刚才叫你保存的最新的授权码）
		$mail->Password = 'admin123';//163邮箱也有授权码 进入163邮箱帐号获取

		//设置发件人邮箱地址 这里填入上述提到的“发件人邮箱”
		$mail->From = '15910720087@163.com';

		//邮件正文是否为html编码 注意此处是一个方法 不再是属性 true或false
		$mail->isHTML(true);

		//设置收件人邮箱地址 该方法有两个参数 第一个参数为收件人邮箱地址 第二参数为给该地址设置的昵称 不同的邮箱系统会自动进行处理变动 这里第二个参数的意义不大
		$mail->addAddress('2548386950@qq.com');

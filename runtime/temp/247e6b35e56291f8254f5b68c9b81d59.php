...
<form class="layui-form" action="">
	<input type="hidden" name="friend_id" value="<?php echo $data['friend_id']; ?>">
	<div class="layui-form-item">
		<label class="layui-form-label">友链名称</label>
		<div class="layui-input-block"><!--   -->
			<input type="hidden" value="<?php echo $data['friend_name']; ?>" id="old_name">
			<input type="text" name="friend_name" required value="<?php echo $data['friend_name']; ?>" lay-verify="required|checkName" autocomplete="off" class="layui-input">
		</div>
	</div>
	<div class="layui-form-item">
		<label class="layui-form-label">网址</label>
		<div class="layui-input-block"><!--  -->
			<input type="text" name="friend_url" value="<?php echo $data['friend_url']; ?>" required lay-verify="required|url" autocomplete="off" class="layui-input">
		</div>
	</div>
	<div class="layui-form-item">
		<div class="layui-input-block">
	...
	$(function(){
		layui.use(['form','layer'],function(){
			...
			form.on('submit(*)', function(data){
			  $.post(
			  		"<?php echo url('Friend/friendUpdate'); ?>",
			  		data.field,
			  		function(result){
			  			// console.log(result);

<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:79:"/data/wwwroot/default/shop/public/../application/index/view/product/detail.html";i:1545035140;}*/ ?>
<div class="list_c">
    <ul class="cate_list">
        ...
        <li>
            <div class="img">
                <a href="<?php echo url('product/product'); ?>?id=<?php echo $v['goods_id']; ?>">
                    <img src="/shop/public/goodsimg/<?php echo $v['goods_img']; ?>" width="210" height="185" />
                </a>
            </div>
            <div class="price">

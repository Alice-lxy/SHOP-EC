<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:77:"/data/wwwroot/default/shop/public/../application/admin/view/role/roleadd.html";i:1545448563;s:71:"/data/wwwroot/default/shop/public/../application/admin/view/layout.html";i:1541750001;s:76:"/data/wwwroot/default/shop/public/../application/admin/view/public/head.html";i:1542158279;s:76:"/data/wwwroot/default/shop/public/../application/admin/view/public/left.html";i:1545302390;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
    ...
    <form class="layui-form" action="">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                ...
                <fieldset>
                    <legend>
                        <input type="checkbox" lay-skin="primary" name="node_id[]" lay-filter="allbox" value="<?php echo $v['node_id']; ?>" title="<?php echo $v['node_name']; ?>">
                    </legend>
                    <div class="layui-field-box">
                        ...
                        <input type="checkbox" lay-skin="primary" name="node_id[]" lay-filter="box" value="<?php echo $vv['node_id']; ?>" title="<?php echo $vv['node_name']; ?>">

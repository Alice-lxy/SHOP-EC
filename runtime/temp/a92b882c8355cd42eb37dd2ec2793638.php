<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:93:"D:\phpStudy\WWW\month11\shop\public/../application/index\view\user_address\addressupdate.html";i:1543806676;s:73:"D:\phpStudy\WWW\month11\shop\public/../application/index\view\layout.html";i:1543627341;s:78:"D:\phpStudy\WWW\month11\shop\public/../application/index\view\public\head.html";i:1543627258;s:82:"D:\phpStudy\WWW\month11\shop\public/../application/index\view\public\user_top.html";i:1543550150;s:83:"D:\phpStudy\WWW\month11\shop\public/../application/index\view\public\user_left.html";i:1543555812;s:80:"D:\phpStudy\WWW\month11\shop\public/../application/index\view\public\footer.html";i:1543625008;}*/ ?>
    ...
    <div class="left_m">
		...
		<div class="m_right">
            ...
            <table border="0" class="add_tab" style="width:930px;"  cellspacing="0" cellpadding="0">
                <input type="hidden" value="<?php echo $address['add_id']; ?>" id="add_id">
                <tr>
                <td width="135" align="right">配送地区</td>
                <td colspan="3" style="font-family:'宋体';">
                <select name="province" class="area" id="province">
                    <option value="" selected="selected">请选择...</option>
                    <?php foreach($provice as $k=>$v): if($v['id'] == $address['province']): ?>
                ...
                <select  name="city" class="area" id="city">
                    <option value="" selected="selected">请选择...</option>
                    <?php foreach($city as $k=>$v): if($v['id'] == $address['city']): ?>
                            <option value="<?php echo $v['id']; ?>" selected><?php echo $v['name']; ?></option>
                        <?php else: ?>
                            <option value="<?php echo $v['id']; ?>"><?php echo $v['name']; ?></option>
                        <?php endif; endforeach; ?>
                ...
                <select name="area" class="area" id="area">
                    <option value="" selected="selected">请选择...</option>
                    <?php foreach($area as $k=>$v): if($v['id'] == $address['area']): ?>
                            <option value="<?php echo $v['id']; ?>" selected><?php echo $v['name']; ?></option>
                        <?php else: ?>
                            <option value="<?php echo $v['id']; ?>"><?php echo $v['name']; ?></option>
                        <?php endif; endforeach; ?>
                ...
                <input type="text" class="add_ipt" name="add_name" id="add_name" value="<?php echo $address['add_name']; ?>"/>（必填）
                </td>
                <td align="right">详细地址</td>
                <td style="font-family:'宋体';">
                  <input type="text" class="add_ipt" name="add_ress" id="add_ress" value="<?php echo $address['add_ress']; ?>"/>（必填）
                </td>
                </tr>
                <tr>
                <td align="right">手机号</td>
                <td style="font-family:'宋体';">
                <input type="text" class="add_ipt" name="add_tel" id="add_tel" value="<?php echo $address['add_tel']; ?>"/>（必填）
                </td>
                <td align="right">最佳送货时间</td>
                <td style="font-family:'宋体';">
                <input type="text" class="add_ipt" name="send_time" id="send_time" value="<?php echo $address['send_time']; ?>"/>
                </td>
                </tr>
                <tr>
            ...
            layui.use(['layer'],function(){
                ...
                $('.add_b').click(function(){
                    ...
                    if(province==''){
                        ...
                        $.post(
                                "<?php echo url('user_address/addressupdate'); ?>",

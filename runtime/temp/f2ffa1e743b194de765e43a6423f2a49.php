<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:78:"D:\phpStudy\WWW\month11\shop\public/../application/index\view\login\login.html";i:1544059461;}*/ ?>
<!DOCTYPE html>
<html>
	<head lang="en">
		<meta charset="UTF-8">
	...
	<body>
		...
		<div class="login-banner">
			<div class="login-main">
				<div class="login-banner-bg"><span></span><img src="__STATIC__/index/login/big.jpg" />
				</div>
				<div class="login-box">
					...
					<div class="login-form">
						<form>
							<div class="user-name">
								...
								<input type="text" id="account" placeholder="手机号/邮箱" value="<?php echo (\think\Cookie::get('account')) ? \think\Cookie::get('account') : ''; ?>">
							</div>
							<div class="user-pass">
								<label for="user_pwd"><i class="am-icon-lock"></i></label>
								<input type="password" id="user_pwd"  placeholder="请输入密码" value="<?php echo (\think\Cookie::get('user_pwd')) ? \think\Cookie::get('user_pwd') : ''; ?>">
							</div>
						</form>
					</div>

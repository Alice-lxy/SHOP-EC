						...
						if(reg.code==1){
							...
							layer.open({
								...
								yes:function(index,layero){
									location.href="<?php echo url('Brand/brandAdd'); ?>";
									return false;
								},

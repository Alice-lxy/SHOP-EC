...
<form class="layui-form" action="">
	<input type="hidden" value="<?php echo $data['cate_id']; ?>" name="cate_id">
	  <div class="layui-form-item">
	    <label class="layui-form-label">分类名称</label>
	    <div class="layui-input-block"><!-- lay-verify="required|checkName" -->
	      <input type="hidden" id="old_name" value="<?php echo $data['cate_name']; ?>">
	      <input type="text" name="cate_name" required lay-verify="required|checkName" value="<?php echo $data['cate_name']; ?>" autocomplete="off" class="layui-input">
	    </div>
	  </div>
	 <div class="layui-form-item">
		<label class="layui-form-label">是否展示</label>
		<div class="layui-input-block">
			<?php if($data['cate_show'] == 1): ?>
	 ...
	 <div class="layui-form-item">
	    ...
	    <div class="layui-input-block">
	      <select name="pid" lay-verify="required">
	        ...
	        <?php foreach($info as $v): if($v['cate_id'] == $data['pid']): ?>
	...
	layui.use(['form','layer'], function(){
		...
		form.on('submit(formDemo)', function(data){
			$.post(
				"<?php echo url('Category/cateUpdate'); ?>",
				data.field,
				function(msg){

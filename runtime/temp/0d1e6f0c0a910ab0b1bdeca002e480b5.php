<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:80:"/data/wwwroot/default/shop/public/../application/index/view/product/product.html";i:1576893773;s:71:"/data/wwwroot/default/shop/public/../application/index/view/layout.html";i:1545033943;s:76:"/data/wwwroot/default/shop/public/../application/index/view/public/head.html";i:1545035142;s:75:"/data/wwwroot/default/shop/public/../application/index/view/public/top.html";i:1576893892;s:78:"/data/wwwroot/default/shop/public/../application/index/view/public/footer.html";i:1545035142;}*/ ?>
...
<div class="i_bg">
	<div class="postion">
    	<span class="fl">全部 ><?php echo $cate_str; ?></span>
    </div>    
    <div class="content">
    	                    
        <div id="tsShopContainer">
            <div id="tsImgS"><a href="/goodsimg/<?php echo $goodsInfo['goods_img']; ?>" title="Images" class="MagicZoom" id="MagicZoom"><img src="/goodsimg/<?php echo $goodsInfo['goods_img']; ?>" width="390" height="390" /></a></div>
            <div id="tsPicContainer">
                <div id="tsImgSArrL" onclick="tsScrollArrLeft()"></div>
                <div id="tsImgSCon" style="width: 1000px">
                    <ul>
                    <?php if(is_array($goodsInfo['goods_imgs']) || $goodsInfo['goods_imgs'] instanceof \think\Collection || $goodsInfo['goods_imgs'] instanceof \think\Paginator): $i = 0; $__LIST__ = $goodsInfo['goods_imgs'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
                        <li onclick="showPic(<?php echo $key; ?>)" rel="MagicZoom" class="tsSelectImg">
                            <img src="/goodsimgs/<?php echo $v; ?>" tsImgS="/goodsimgs/<?php echo $v; ?>" width="79" height="79" />
                        </li>
                    <?php endforeach; endif; else: echo "" ;endif; ?>
                    </ul>
                </div>
        ...
        <div class="pro_des">
            ...
            <div class="des_price">
            	本店价格：<b>￥<?php echo $goodsInfo['goods_selfprice']; ?></b><br />
                消费积分：<span><?php echo $goodsInfo['goods_fen']; ?>R</span>
            </div>
            ...
            <input type="hidden" id="goods_num" value="<?php echo $goodsInfo['goods_num']; ?>">
            <span>共剩余<?php echo $goodsInfo['goods_num']; ?>件库存</span>
            <div class="des_join">
            	<div class="j_nums">
                ...
                <span class="fl">
                    <a onclick="javascript:;" id="btn"><img src="__STATIC__/index/images/j_car.png" /></a>
                </span>
            </div>            
        </div>
        <div class="s_brand">
            ...
            <div class="des_border" id="p_details">
                ...
                <div class="des_con">
                	<table border="0" align="center" style="width:745px; font-size:14px; font-family:'宋体';" cellspacing="0" cellpadding="0">
                      <tr>
                        <td width="265"><img src="/goodsimg/<?php echo $goodsInfo['goods_img']; ?>" width="500" height="412" /></td>
                      </tr>
                      <tr>
                        <td>
...
<script>
    $(function(){
        layui.use(['layer'],function(){
            ...
            $('.add').click(function(){
                var _this = $(this);
                changeNumber(1,_this);
            });
            //减号
            $('.reduce').click(function(){
                var _this = $(this);
                changeNumber(2,_this);
            });
            //件数的改变
            function changeNumber(type,_this){
                //获取文本框
            ...
            $('#btn').click(function(){
                ...
                var buy_number = $('#buy_number').val();//商品件数
                ...
                $.post(
                    ...
                    function(result){
                        if(result.code==1){
                            layer.confirm(result.font,function(){

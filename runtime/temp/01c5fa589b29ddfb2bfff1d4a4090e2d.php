<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:76:"/data/wwwroot/default/shop/public/../application/index/view/index/index.html";i:1576894368;s:71:"/data/wwwroot/default/shop/public/../application/index/view/layout.html";i:1545033943;s:76:"/data/wwwroot/default/shop/public/../application/index/view/public/head.html";i:1545035142;s:75:"/data/wwwroot/default/shop/public/../application/index/view/public/top.html";i:1576893892;s:78:"/data/wwwroot/default/shop/public/../application/index/view/public/footer.html";i:1545035142;}*/ ?>
...
<div class="i_bg bg_color">
        ...
        <div class="banner">        
            <div class="top_slide_wrap">
                <ul class="slide_box bxslider">
                    <li><img src="https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1545110239724&di=71ea8bd085266f0e8596b0861162a40f&imgtype=0&src=http%3A%2F%2Fimg.alicdn.com%2FL1%2F249%2F14310462562606%2F1.0.0%2Fimg%2F14321119249643.jpg" width="740" height="401" /></li>
                    <li><img src="https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1545110555441&di=e0e02e74f08b7c4b1550d8799409550f&imgtype=0&src=http%3A%2F%2Fpic29.nipic.com%2F20130509%2F8668035_094636921000_2.jpg" width="740" height="401" /></li> 
                    <li><img src="https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1545110887299&di=7da09816fc682cfd38a1d5c7ad2a5cd8&imgtype=0&src=http%3A%2F%2Fimg.alicdn.com%2Fimgextra%2Fi1%2FTB2YBH0rER1BeNjy0FmXXb0wVXa_%2521%25212843620219.jpg_400x400.jpg" width="740" height="401" /></li> 
                </ul>   
    ...
    <!--Begin 进口 生鲜 Begin-->
    <div cate_id="<?php echo $info['topData']['cate_id']; ?>" floor_num="1">
        <div class="i_t mar_10">
            ...
            <div class="fresh_mid">
                <ul>
                    ...
                    <li>
                        ...
                        <div class="img"><a href="<?php echo url('product/product'); ?>?id=<?php echo $v['goods_id']; ?>"><img src="/goodsimg/<?php echo $v['goods_img']; ?>" width="185" height="155" /></a></div>
                    </li>
                    <?php endforeach; endif; else: echo "" ;endif; ?>                     
                </ul>
            </div>
    ...
    <!--End 进口 生鲜 End-->
    <div align="center"><a href="javascript:;" id="more">加载更多...</a></div>
    <!-- Begin 广告 Begin -->
    <div class="content mar_20">
...
<script>
    $(function(){
        $('#more').click(function(){
            var _this = $(this);
            var cate_id = _this.parent().prev('div').attr('cate_id');
            var floor_num = _this.parent().prev('div').attr('floor_num');

           
            $.post(
                "<?php echo url('Index/getMoreFloor'); ?>",

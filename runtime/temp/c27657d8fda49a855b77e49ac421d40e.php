    ...
    <div class="content mar_20">
    	<div class="l_history">
        	...
        	<ul>
            	...
            	<li>
                    <div class="img"><a href="#"><img src="/public/goodsimg/<?php echo $v['goods_img']; ?>" width="185" height="162" /></a></div>
                	<div class="name"><a href="#"><?php echo $v['goods_name']; ?></a></div>
                    <div class="price">

<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:78:"D:\phpStudy\WWW\month11\shop\public/../application/admin\view\login\login.html";i:1542110384;}*/ ?>
<!DOCTYPE html>
        ...
        <div id="large-header" class="large-header">
            ...
            <div class="logo_box">
                ...
                <form  method="post"  class="layui-form">
                    ...
                    <div>
                        <input type="text" name="mycode" lay-verify="required" style="width: 120px;height: 50px;border-radius: 25px;border: 1px solid #ccc;">
                ...
                $.post(
                    ...
                    function(result){
                        ...
                        if(result.code==1){
                            ...
                            $('#code').prop('src',"<?php echo captcha_src(); ?>");
                        }
                    },'json'
                );
